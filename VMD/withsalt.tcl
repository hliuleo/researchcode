...
puts "  nowater - is prefix used for output waterless pdb for system.mae and stk trajectory"
...
proc remove_water {SysMae TrjSTK Prefix Selection} {
	...
	set nowatsel [atomselect top "protein or resname NME or resname LI or resname CL"]
