# save dcd trajectory to pdb format. This is used for calculating native contacts by Mojie's code.
...
set last [expr $nf -1]
animate write pdb "all.pdb" beg 1 end $last sel $sel waitfor all 0
exit
